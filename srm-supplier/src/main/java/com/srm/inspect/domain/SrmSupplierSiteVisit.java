...
public class SrmSupplierSiteVisit extends BaseEntity {
    ...
    public void setSrmSupplierSiteVisitUserList(List<SrmSupplierSiteVisitUser> srmSupplierSiteVisitUserList) {
        this.srmSupplierSiteVisitUserList = srmSupplierSiteVisitUserList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("srmSupplierSiteVisitUserList", getSrmSupplierSiteVisitUserList())
                .toString();
    }
}
